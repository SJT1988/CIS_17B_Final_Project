...
void Game::init(const char* title, int width, int height, bool fullscreen)
{
	...
	tileSet = new Map("Assets/tileset.png", 1, TILE_SIZE);
	// mapBG = new Map("Assets/tileset.png", 1, TILE_SIZE);
	// map = new Map("Assets/tileset.png)", 1, TILE_SIZE);
	// mapFX = new Map("Assets/tileset.png", 1, TILE_SIZE);
	...
	// background map:
	tileSet->LoadMap("Assets/map01BG.map", 11, 11, Game::groupMapBG);
	// 'the' map:
	...
	// fx map/overlays:
	tileSet->LoadMap("Assets/map01FX.map", 11, 11, groupMapFX);

	// load colliders
	tileSet->Map::LoadColliders("Assets/map01Colliders.map", 11, 11);
}
